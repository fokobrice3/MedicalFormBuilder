        ...
        r.m = e, r.c = t, r.d = function(e, t, o) {
            ...
            return Object.prototype.hasOwnProperty.call(e, t)
                ...
                r.n(o).a.addLanguage("en-US", {
                    ...
                    allowMultipleFiles: "Permettre aux utilisateurs de télécharger plusieurs fichiers",
                    ...
                    className: "Class",
                    clearAllMessage: "Êtes-vous sûr de vouloir effacer tous les champs ?",
                    clear: "Effacer",
                    close: "Fermer",
                    content: "Contenu",
                    copy: "Copier dans le presse-papiers",
                    copyButton: "&#43;",
                    copyButtonTooltip: "Copie",
                    ...
                    enableOtherMsg: "Permettre aux utilisateurs de saisir une option non répertoriée",
                    ...
                    getStarted: "Glisser les éléments dans cette zone",
                    header: "Titre",
                    hide: "Modifier",
                    hidden: "Hidden Input",
                    inline: "Inline",
                    ...
                    label: "Label",
                    labelEmpty: "Le label du champ ne peut pas être vide",
                    limitRole: "Limiter l'accès à un ou plusieurs des rôles suivants:",
                    mandatory: "Mandatory",
                    maxlength: "Longueur max",
                    minOptionMessage: "Ce champ requiert un minimum de 2 options",
                    minSelectionRequired: "Minimum {min} sélections requises",
                    multipleFiles: "Fichiers multiples",
                    name: "Nom",
                    no: "Non",
                    noFieldsToClear: "Il n'y a pas de champs à vider",
                    number: "Nombre",
                    off: "Off",
                    on: "On",
                    option: "Option",
                    ...
                    "placeholders.value": "Valeur",
                    "placeholders.label": "Label",
                    "placeholders.email": "Entrez votre courriel",
                    "placeholders.className": "Classes séparées par des espaces",
                    "placeholders.password": "Entrez votre mot de passe",
                    preview: "Prévisualisation",
                    radioGroup: "Radio Group",
                    radio: "Radio",
                    removeMessage: "Retirer l'élément",
                    removeOption: "Supprimer l'option",
                    remove: "&#215;",
                    required: "Requis",
                    requireValidOption: "Accepter uniquement une option prédéfinie",
                ...
                class l extends o.a {
                    static register(e = {}, t = []) {
                        ...
                        for (const n of t) {
                            ...
                            if (n.attrs = n.attrs || {}, !t) {
                                if (!n.attrs.type) {
                                    this.error("Définition de champ personnalisé invalide. Veuillez spécifier une propriété de type.");
                                    continue
                                }
                                t = n.attrs.type
                            }
                            ...
                            if (!e[t]) {
                                ...
                                if (!e) {
                                    this.error("Erreur lors de l'enregistrement d'un champ personnalisé: " + t + (n.subtype ? ":" + n.subtype : "") + ". Unable to find any existing defined control or template for rendering.");
                                    continue
                                }
                    ...
                    build() {
                        ...
                        if (!e) return this.error("Type de contrôle personnalisé non valide. Veuillez vous assurer que vous l'avez enregistré correctement comme option de modèle.");
